...
- If you are using Quarto within RStudio it is strongly recommended that you use the latest release of RStudio.
:::
...
### Renderizar y Vista previa

::: {.incremental .small-par}
::: {.small-par}
* Use the Render button in the RStudio IDE to render the file and preview the output with a single click.
  []{.small-par}
  ![](images/rstudio_render.png){width="60%"}
:::
::: {.small-par}
* If you prefer to automatically render whenever you save, you can check the Render on Save option on the editor toolbar. The preview will update whenever you re-render the document.
  []{.small-par}
...
* Visual editor for Quarto markdown, including support for tables, citations, cross-references, footnotes, divs/spans, definition lists, attributes, raw HTML/TeX, and more
  []{.small-par}
