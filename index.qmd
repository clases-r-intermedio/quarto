...
::: {.incremental .small-par}
* **TODO:** add list of short exercises to edit and render some of the presented docs.
:::
...
::: {.small-par}
1)  Trabajaremos en una copia del mismo dashboard que hemos visto en las diapositivas anteriores y usaremos el dataset **gapminder**.
