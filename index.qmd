...
- El objetivo de Quarto es mejorar el proceso de creación y colaboración en documentos científicos y técnicos.
...
![](images/ejercicio_1_solucion_01.png){.fragment .fade-in-then-out width="80%"}

![](images/ejercicio_1_solucion_02.png){.fragment .fade-in-then-out width="90%"}
...
2) Active la casilla **Render on Save** en RStudio, para que cada vez que guarde el documento éste sea renderizado y se actualice su previsualización.
3) Cree un archivo llamado <span style="color:#4758ab;"> code_embed.qmd</span>, que contenga dos bloques de código, donde en cada bloque se use el dataset <span style="color:#4758ab;"> airquality </span> para lo siguiente: 
   - a) El **primer bloque** debe generar una tabla de Temperatura [°C] versus Viento [km/hr]. Asigne a este bloque la etiqueta <span style="color:#4758ab;"> code-1</span>.
   - b) El **segundo bloque** debe generar un gráfico de Temperatura [°C] versus Viento [km/hr], con la leyenda "Gráfico de Temperatura versus Viento". Asigne a este bloque la etiqueta <span style="color:#4758ab;"> fig-1</span>.
4) Agregue un **Capítulo** al documento <span style="color:#4758ab;"> ejercicio_code_embed.qmd</span>, con tres **Secciones** en que se muestren los siguientes resultados, en base al output resultante de los bloques de código creados en el archivo <span style="color:#4758ab;"> code_embed.qmd</span>.
   - **Sección 1:** debe mostrar los 10 primeros registros de la tabla generada por el **primer bloque** de código, mientras que el código y cualquier posible *warning* deben  omitirse.
   - **Sección 2:** debe mostrar el gráfico generado por el **segundo bloque** de código, mientras que el código y cualquier posible *warning* deben omitirse. 
   - **Sección 3:** un *tabset* con dos pestañas, en que: 
     - La **primera pestaña** muestre el código y tabla generada por el **primer bloque** de código. El código debe aparecer colapsado, de manera que pueda ser desplegado interactivamente. 
     - **La segunda pestaña** muestre el código y el gráfico generado por el **segundo bloque** de código. El código debe aparecer colapsado, de manera que pueda ser desplegado interactivamente.

   Visualice que el nuevo contenido aparezca en el documento de Quarto después de renderizar.
:::
...
![](images/ejercicio_2_solucion_01.png){.fragment .fade-in-then-out width="80%"}

![](images/ejercicio_2_solucion_02.png){.fragment .fade-in-then-out width="90%"}

![](images/ejercicio_2_solucion_03.png){.fragment .fade-in-then-out width="90%"}
...
- Y pueden ser desplegados como páginas web estáticas (sin requerir un servidor) o integrando un backend [Shiny Server](/docs/dashboards/interactivity/shiny-python/index.qmd) para aumentar la interactividad.
  - En esta clase sólo nos concentraremos en entender cómo generar un dashboard estático, ya que integrar un backend es un tema más avanzado.
:::
...
3)  En la primera columna (izquierda), muestre una tabla que contenga la expectativa de vida (columna **lifeExp**), el GDP per cápita (columna **gdpPercap**) y el tiempo (columna **year**) para los países (columna **country**) de Chile, Argentina y Brasil, en todo el rango de tiempo disponible.
4)  En la segunda columna (derecha), cree un tabset con dos pestañas (*tabs*).
    - La primera pestaña debería mostrar un gráfico de **expectativa de vida versus tiempo**, para los tres países. El título de la pestaña debe ser **Expectativa de vida en el tiempo**. 
    - La segunda pestaña debería mostrar un gráfico de la **evolución en el tiempo del GDP per cápita** en cada país. El título de la pestaña debe ser **GDP per cápita en el tiempo**.  
:::
...
![](images/ejercicio_3_solucion_01.png){.fragment .fade-in-then-out width="100%"}

![](images/ejercicio_3_solucion_02.png){.fragment .fade-in-then-out width="100%"}
