...
::: {.incremental .small-par}
- Pandoc, la versión de Markdown usada en Quarto, soporta una gran cantidad de formatos de salida.
- En esta clase examinaremos sólo algunos de los más comunes: 
  ...
  - MS Word: formato del procesador de palabras incluido en Microsoft Office.
  - Typst: formato nuevo open-source diseñado para ser tan poderoso como LaTeX pero siendo más fácil de usar y aprender.
...
::: {.incremental .small-par}
- A modo de ejemplo, veamos cómo podrían diseñarse en Quarto documentos con los principales formatos.
  - Aquí sólo mostramos parte de cada documento, cuya versión completa se encuentra en el archivo renderizado correspondiente que acompaña esta clase.  
:::
...
---
title: "Documento Typst"
subtitle: "Ejemplo de documento generado en Quarto"
date: today
author: "Capacitación R Intermedio"
format:
  typst: # <1>
    output-file: "document_typst.pdf"
    toc: true
    toc-depth: 3
    toc-title: Contenido
    number-sections: true
    papersize: "us-letter" # <2>
    section-numbering: 1.1.a # <3>
---
...
````
1. Algunas opciones específicas del formato: 
2. `papersize` define el tamaño del documento impreso.
3. `section-numbering` define el esquema usado para numerar secciones, por ejemplo 1.A.1.
...
---
title: "Documento MS Word"
subtitle: "Ejemplo de documento generado en Quarto"
date: today
author: "Capacitación R Intermedio"
format:
  docx:
    output-file: "document_word.docx"
    toc: true
    toc-depth: 3
    toc-title: Contenido
    number-sections: true
...
::: {.incremental .small-par}
- Ahora veamos cómo luce el documento después de renderizar cada formato de Quarto. 
:::
...
::: {.center}
![](images/example_document_typst.png){width="90%"}
:::

### MS Word

::: {.center}
![](images/example_document_word.png){width="80%"}
:::
